...
public class AsciiGraphicsController implements Initializable {
    ...
    @FXML
    private Label asciiMessageLabel;
    @FXML
    private TextArea asciiResultTextArea;
    @FXML
    ...
    @Inject
    public AsciiGraphicsController(AsciiService asciiService) {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        HBox.setMargin(asciiMessageLabel, new Insets(10, 5, 10, 0));

        asciiResultTextArea.setPrefRowCount(128);
        asciiResultTextArea.setFont(Font.font(java.awt.Font.MONOSPACED, 12));
    ...
    private void doConvert() {
        ...
        if (validate()) {
            ...
            asciiResultTextArea.setText(converted);
        }
    }
